...
def testErrors(ntrials,npts=100):
    results = [0] * ntrials
...
def fitData1(fileName):
    ...
    pylab.plot(xVals, estYVals, label = 'Linear fit' + 'r^2 = ' + str(r2))
    a,b,c,d = pylab.polyfit(xVals, yVals, 3)
    estYVals = a*(xVals**3) + b*xVals**2 + c*xVals + d
    r2 = rSquare(yVals, estYVals)
    pylab.plot(xVals, estYVals, label = 'Cubic fit' + 'r^2 = ' + str(r2))
    pylab.legend(loc = 'best')
